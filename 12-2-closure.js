...
allowing the function’s body to use local values that were visible at the time
...
argument to f’s argument, meaning that it needs access to the local scope 
